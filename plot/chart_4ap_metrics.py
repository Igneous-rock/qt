...
def plot_scatter(dic_cm_ref,dic_cm_rst):
	...
	ax1.scatter(x1,y1,c=color_p,alpha = 0.5)
	#labels = d_set[1]
	...
	ax2.scatter(x2,y2,c=color_p,alpha = 0.5)
	...
	ax3.scatter(x3,y3,c=color_p,alpha = 0.5)
	...
	ax4.scatter(x4,y4,c=color_p,alpha = 0.5)
...
def chart_scatter_plot(P_shp):
	f_ref = P_shp + '2000_Merge_unicd.shp'
	f_rst = P_shp + 'lakes_final.shp'
	p_csv = './'
...
if __name__ == '__main__':
	a = time.clock()
	P_shp = 'D:/python/Project/QT/Lake_2000_TP/'
